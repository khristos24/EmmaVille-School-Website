        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img
                src="https://images.unsplash.com/photo-1744809482817-9a9d4fc280af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWFjaGVyJTIwc3R1ZGVudHMlMjBpbnRlcmFjdGlvbnxlbnwxfHx8fDE3NjM1NzM3ODJ8MA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="about_school.jpg - teacher + students"
          ...
          >
            ...
            <p className="text-gray-700 text-base md:text-lg mb-4 md:mb-6 leading-relaxed">
              ...
              curious minds and building character through a rigorous, personalized 
              curriculum and a supportive community.
            </p>
            <div className="bg-emerald-50 border-l-4 border-emerald-600 p-4 mb-6 md:mb-8 rounded-r-lg">
              <p className="text-emerald-800 italic">
                "Educating the whole child — intellectually, socially, and ethically."
              </p>
            </div>
            <Button 
